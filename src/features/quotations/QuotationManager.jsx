...
export default function QuotationManager({ businessProfile = {}, onConvertToBooking, onConvertToInvoice, session }) {
  ...
  return <>
    <div className="quotation-page">
      <div className="quotation-top"><button className="q-back" onClick={() => window.history.back()}>← Back</button><div><h2>Quotations</h2><p>Create professional quotations before confirming a booking.</p></div><button className="q-primary" onClick={newQuotation}>+ New Quotation</button></div>
