      ...
      <div className="customization-card">
        <div className="section-heading">
          <div>
            ...
            <p>Upload your business logo and digital signature. They will automatically appear on invoices.</p>
          </div>
        </div>
        ...
        <div className="two-col">
          <div className="upload-placeholder">
            ...
            <h3>Business Logo</h3>
            <p>Choose a JPG or PNG image. Maximum 5MB.</p>
            {logoPreview && (
              <>
                <img src={logoPreview} className="settings-image" alt="Business logo preview" />
                <ImageActions url={logoPreview} label="Business Logo" />
              </>
            )}
            <input
              ref={logoInputRef}
              ...
              hidden
              onChange={e => uploadPrivateImage(e.target.files?.[0], "logo")}
            />
            <button type="button" className="gold-button" onClick={() => logoInputRef.current?.click()} disabled={logoUploading}>
          ...
          <div className="upload-placeholder">
            ...
            <p>Choose a JPG or PNG image. Maximum 5MB. White background is removed automatically.</p>
            {signaturePreview && (
              <>
                <img src={signaturePreview} className="settings-signature" alt="Digital signature preview" />
                <ImageActions url={signaturePreview} label="Signature" />
              </>
            )}
            <input
              ...
              accept="image/png,image/jpeg,image/jpg"
              hidden
              onChange={e => uploadPrivateImage(e.target.files?.[0], "signature")}
            />
            <button type="button" className="gold-button" onClick={() => signatureInputRef.current?.click()} disabled={signatureUploading}>
              {signatureUploading ? "Uploading..." : signaturePreview ? "Change Signature" : "Upload Signature"}
            </button>
